...
abstract class Form extends \Nette\Application\UI\Form
{
    ...
    public function __construct()
    {
		...
		$this->annotationReader = \Foxy\DI\Extension::getAnnotationReader();
    ...
    private function customizeMetadata($field, array & $properties)
    {
        ...
        foreach($this->annotationReader->getPropertyAnnotations($rp) as $a) {
    ...
    public function flashMessage($status = 'success')
    {
        ...
        $this->presenter->flashMessage($message, $status);
    }
